...
function show_err_msg(msg){
	 ...
	 var errhtml='<div  class="bac" style="padding:8px 0px;width:100%;margin:0 auto;background-color:#fff;color:#B90802;text-align:center;font-size:16px;">';
	 var errhtmlfoot='</div>';	 
...
function show_msg(msg,url){	
	 ...
	 clearTimeout(msgdsq);
	 $('body').append('<div class="sub_err" style="position:absolute;top:60px;left:0;width:500px;z-index:999999;"></div>');
	 var htmltop='<div class="bac" style="padding:8px 0px;border:1px solid #090;width:100%;margin:0 auto;background-color:#FFF2F8;color:#090;text-align:center;font-size:16px;">';
	 var htmlfoot='</div>';
	 $('.msg_bg').height($(document).height());
	 var left=($(document).width()-500)/2;
	 $('.sub_err').css({'left':left+'px'});
