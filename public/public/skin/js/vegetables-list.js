$(function() {
	...
	function setListData(data) {
		...
		for(var i = 0; i < data.length; i++) {
			var pd = data[i];
			var str = '<a href="/index.php/wap/product/details?goods_id='+pd.goods_id+'">';
			    str += '<div class="specialty-box">';
			    str += '<div class="list-bd">';
			    str += '<div class="orderimg"><img src="'+ pd.original_img +'"/></div>';
			    str += '<div class="text">';
			    str += '<h1>'+ pd.goods_name +'</h1>';
			    str += '<p class="textsp">'+ pd.goods_remark +'</p>';
			    str += '<div class="spprice">';
			    str += '<small>¥</small>';
