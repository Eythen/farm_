...
class Upgrade extends Relation
{
    public $app_path;
    ...
    function  __construct() {
        ...
        $this->version_txt_path = $this->app_path.'/application/home/version.txt'; // 版本文件路径
    ...
    public  function OneKeyUpgrade(){
        ...
        if(!file_exists($this->app_path.'backup/'.$folderName.'/www/Application/home/Conf/version.txt'))
