...
class Payment extends Base {
    ...
    public function getCode(){     
            ...
            elseif($type == 'agent'){
                db('agent_order')->where("order_id = $order_id")->update(array('pay_code'=>$this->pay_code,'pay_name'=>$payment_arr[$this->pay_code]));
                $order = db('agent_order')->where("order_id = $order_id")->find(); 
            }
            else{
