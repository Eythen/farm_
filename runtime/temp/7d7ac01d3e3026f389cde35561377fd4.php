...
<body>
        ...
        <table class="table text-center table-hover table-condensed" data-toolbar="#toolbar" data-toggle="table" data-sort-name="id" data-sort-order="desc" data-url="<?php echo url('goodslist'); ?>" data-side-pagination="server" data-pagination="true" data-page-list="[10, 20, 50, 100, 200]" data-show-refresh="true" data-search="false" data-show-export="true" data-filter-control="true" data-filter-show-clear="true" >
            <thead>
                <tr>
                    ...
                    <th data-halign="center" data-field="goods_name" data-filter-control="input" >单品</th>
                    <th data-halign="center" data-field="shop_price" data-filter-control="input">单品价格</th>
    ...
    /*<input type="text" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')"  onchange="ajaxUpdateField(this);" name="store_count" size="4" data-table="goods" data-id="<?php echo $list['goods_id']; ?>" value="<?php echo $list['store_count']; ?>"/>   
        ...
        function is_on_sale_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_goods\',\'goods_id\','+row.goods_id+',\'is_on_sale\',this)"/>';
        ...
        function is_new_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_goods\',\'goods_id\','+row.goods_id+',\'is_new\',this)"/>';
        ...
        function is_recommend_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_goods\',\'goods_id\','+row.goods_id+',\'is_recommend\',this)"/>';
        ...
        function is_hot_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_goods\',\'goods_id\','+row.goods_id+',\'is_hot\',this)"/>';
...
//                var url = "<?php echo url('wap/Goods/show'); ?>"+"?goods_id="+row.goods_id;
//                window.open(url);
//            },
            ...
            'click .edit': function (e, value, row, index) {
                var url = "<?php echo url('addEditGoods'); ?>"+"?goods_id="+row.goods_id;
                location.href=url;
        ...
        $(function(){
            ...
            $(".mysearch_btn").click(function(event) {
                ...
                var url = "<?php echo url('goodslist'); ?>"+"?"+search;
