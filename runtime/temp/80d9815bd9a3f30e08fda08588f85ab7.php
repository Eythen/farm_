<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:81:"/Applications/MAMP/htdocs/farm/public/../application/wap/view/users/cardpack.html";i:1516084569;}*/ ?>
<!DOCTYPE html>
				...
				<div class="weui-panel__bd">
					<div class="weui-media-box weui-media-box_small-appmsg">
						<div class="weui-cells">
							<a class="weui-cell weui-cell_access" href="<?php echo url('red', ['type'=>5]); ?>">
								<div class="pack-icon"><img src="__PUBLIC__/skin/img/icon/hb.png"/></div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>红包</p>
								</div>
								<span class="weui-cell__ft"></span>
							</a>
							<!--<a class="weui-cell weui-cell_access" href="<?php echo url('red', ['type'=>1]); ?>">-->
								<!--<div class="pack-icon"><img src="__PUBLIC__/skin/img/icon/jkq.png"/></div>-->
								<!--<div class="weui-cell__bd weui-cell_primary">-->
									<!--<p>优惠券</p>-->
								<!--</div>-->
								<!--<span class="weui-cell__ft"></span>-->
							<!--</a>-->
							<a class="weui-cell weui-cell_access" href="<?php echo url('red', ['type'=>6]); ?>">
								<div class="pack-icon"><img src="__PUBLIC__/skin/img/icon/dhq.png"/></div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>兑换券</p>
								</div>
								<span class="weui-cell__ft"></span>
							</a>
							<a class="weui-cell weui-cell_access" href="<?php echo url('red', ['type'=>7]); ?>">
								<div class="pack-icon"><img src="__PUBLIC__/skin/img/icon/jkq.png"/></div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>折扣券</p>
								</div>
