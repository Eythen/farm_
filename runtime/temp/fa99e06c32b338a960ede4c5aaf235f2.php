<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/Applications/MAMP/htdocs/farm/public/../application/wap/view/users/news.html";i:1516084569;}*/ ?>
<!DOCTYPE html>
				...
				<div class="weui-panel__bd">
					<div class="weui-media-box weui-media-box_small-appmsg">
						<div class="weui-cells">
							<a class="weui-cell weui-cell_access" href="<?php echo url('message', ['type' => 1]); ?>">
								<div class="news-icon red">信</div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>站内信息</p>
								</div>
								<span class="weui-cell__ft"><?php if(!(empty($system_num) || (($system_num instanceof \think\Collection || $system_num instanceof \think\Paginator ) && $system_num->isEmpty()))): ?><span class="drgedg-badge"><?php echo $system_num; ?></span><?php endif; ?></span>
							</a>
							<a class="weui-cell weui-cell_access" href="<?php echo url('message', ['type' => 3]); ?>">
								<div class="news-icon green">递</div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>快递信息</p>
								</div>
								<span class="weui-cell__ft"><?php if(!(empty($express_num) || (($express_num instanceof \think\Collection || $express_num instanceof \think\Paginator ) && $express_num->isEmpty()))): ?><span class="drgedg-badge"><?php echo $express_num; ?></span><?php endif; ?></span>
							</a>
							<a class="weui-cell weui-cell_access" href="<?php echo url('message', ['type' => 2]); ?>">
								<div class="news-icon yellow">惠</div>
								<div class="weui-cell__bd weui-cell_primary">
									<p>优惠信息</p>
								</div>
								<span class="weui-cell__ft"><?php if(!(empty($coupoun_num) || (($coupoun_num instanceof \think\Collection || $coupoun_num instanceof \think\Paginator ) && $coupoun_num->isEmpty()))): ?><span class="drgedg-badge"><?php echo $coupoun_num; ?></span><?php endif; ?></span>
							</a>
						</div>
					</div>
				</div>
