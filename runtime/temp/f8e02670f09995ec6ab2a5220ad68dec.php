...
<body>
    ...
    /*<input type="text" onkeyup="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')"  onchange="ajaxUpdateField(this);" name="store_count" size="4" data-table="goods" data-id="<?php echo $list['goods_id']; ?>" value="<?php echo $list['store_count']; ?>"/>   
        ...
        function is_on_sale_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_combo_goods\',\'goods_id\','+row.goods_id+',\'is_on_sale\',this)"/>';
        ...
        function is_new_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_combo_goods\',\'goods_id\','+row.goods_id+',\'is_new\',this)"/>';
        ...
        function is_recommend_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_combo_goods\',\'goods_id\','+row.goods_id+',\'is_recommend\',this)"/>';
        ...
        function is_hot_Formatter(value, row, index) {
            ...
            return '<img width="20" height="20" src="__PUBLIC__/images/'+img+'" onclick="changeTableVal(\'book_combo_goods\',\'goods_id\','+row.goods_id+',\'is_hot\',this)"/>';
...
//            },
            ...
            'click .edit': function (e, value, row, index) {
                var url = "<?php echo url('addEditComboGoods'); ?>"+"?goods_id="+row.goods_id;
                location.href=url;
            ...
            'click .remove': function (e, value, row, index) {
                $.ajax({
                    url: "<?php echo url('delComboGoods'); ?>",
                    type: 'POST',
                    dataType: 'json',
        ...
        $(function(){
            ...
            $(".mysearch_btn").click(function(event) {
                ...
                var url = "<?php echo url('combogoodslist'); ?>"+"?"+search;
